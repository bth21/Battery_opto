...
global  UART_Setup, UART_Transmit_Message, UART_Transmit_Byte, UART_Write_Hex, UART_decimalpoint, UART_Space

psect udata_acs   ; reserve data space in access ram
UART_counter: ds    1    ; reserve 1 byte for variable UART_counter
UART_tmp: ds 1    ; reserve 1 byte for variable LCD_hex_tmp
UART_hex_tmp: ds 1    ; reserve 1 byte for variable LCD_hex_tmp
...
UART_decimalpoint:  ;displaying decimal point on LCD
    movlw   '.'
    call    UART_Transmit_Byte
    return
   
UART_Space: ;displaying decimal point on LCD
    movlw   ','
    call    UART_Transmit_Byte
    return
